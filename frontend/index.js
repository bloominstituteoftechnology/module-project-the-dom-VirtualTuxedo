function moduleProject1() {
  ...
  const munboJumbo = `We need to ${randomVerb1} our ${randomNoun1} ${randomAdverb1} in order to ${randomAdverb2} our ${randomNoun2} ${randomAdverb2}.`
  const paragrapth = document.createElement('p')
  paragrapth.textContent = munboJumbo
  document.querySelector('.corporatespeak').appendChild(paragrapth)
